...
namespace Proxies\__CG__\AppBundle\Entity\MAC;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Categoria extends \AppBundle\Entity\MAC\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\MAC\\Categoria' . "\0" . 'nome', '' . "\0" . 'AppBundle\\Entity\\MAC\\Categoria' . "\0" . 'estado', '' . "\0" . 'AppBundle\\Entity\\MAC\\Categoria' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\MAC\\Categoria' . "\0" . 'dependencia'];
        }
