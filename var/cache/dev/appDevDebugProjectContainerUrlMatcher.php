    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/a')) {
            if (0 === strpos($pathinfo, '/api')) {
                // soapx
                if ($pathinfo === '/api/api') {
                    return array (  '_controller' => 'Api\\SoapBundle\\Controller\\DefaultController::indexAction',  '_route' => 'soapx',);
                }

                // soap
                if ($pathinfo === '/api/soap/check') {
                    return array (  '_controller' => 'Api\\SoapBundle\\Controller\\SoapController::checkAction',  '_route' => 'soap',);
                }
        ...
        // resetpassord
        if ($pathinfo === '/resetpassord') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::acervosAction',  '_route' => 'resetpassord',);
        }

        // resetpassword_start
        if (0 === strpos($pathinfo, '/sys/resetpassword') && preg_match('#^/sys/resetpassword/(?P<urlValidator>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'resetpassword_start')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::visitasAction',));
        }
        ...
        if (0 === strpos($pathinfo, '/definicoes')) {
            // definicoes
            if ($pathinfo === '/definicoes') {
                return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::settingsAction',  '_route' => 'definicoes',);
            }

            // definicoes_config
            if (preg_match('#^/definicoes/(?P<tipo>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_definicoes_config;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'definicoes_config')), array (  '_controller' => 'AppBundle\\Controller\\DefaultController::definicoesAction',));
            }
            not_definicoes_config:
        ...
        if (0 === strpos($pathinfo, '/acervos')) {
            // acervos
            if (rtrim($pathinfo, '/') === '/acervos') {
                ...
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'acervos');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\MAC\\AmostraController::indexAction',  '_route' => 'acervos',);
            }
            not_acervos:

            // amostra_new
            if ($pathinfo === '/acervos/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
            ...
            // listarCategoria
            if (0 === strpos($pathinfo, '/acervos/listarCategoria') && preg_match('#^/acervos/listarCategoria/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'listarCategoria')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\AmostraController::listarCategoria',));
            }

            // configuracoesAmostra
            if (0 === strpos($pathinfo, '/acervos/configuracoes') && preg_match('#^/acervos/configuracoes(?:/(?P<conf>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'configuracoesAmostra')), array (  'conf' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\AmostraController::configuracoes',));
            }

            // amostra_show
            if (preg_match('#^/acervos/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
            ...
            // acervo_show
            if (preg_match('#^/acervos/(?P<acervo>[^/]++)/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_acervo_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'acervo_show')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\AmostraController::selfshowAction',));
            }
            not_acervo_show:

            // amostra_edit
            if (preg_match('#^/acervos/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
        ...
        if (0 === strpos($pathinfo, '/brilho')) {
            // brilho_index
            if (rtrim($pathinfo, '/') === '/brilho') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_brilho_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'brilho_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\MAC\\BrilhoController::indexAction',  '_route' => 'brilho_index',);
            }
            not_brilho_index:

            // brilho_new
            if (0 === strpos($pathinfo, '/brilho/new') && preg_match('#^/brilho/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_brilho_new;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'brilho_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\BrilhoController::newAction',));
            }
            not_brilho_new:

            // brilho_delete
            if (0 === strpos($pathinfo, '/brilho/delete') && preg_match('#^/brilho/delete(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_brilho_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'brilho_delete')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\BrilhoController::deleteAction',));
            }
            not_brilho_delete:

            // brilho_show
            if (preg_match('#^/brilho/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_brilho_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'brilho_show')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\BrilhoController::showAction',));
            }
            not_brilho_show:

            // brilho_edit
            if (preg_match('#^/brilho/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_brilho_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'brilho_edit')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\BrilhoController::editAction',));
            }
            not_brilho_edit:
            ...
            if (preg_match('#^/brilho/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_brilho_deletex;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'brilho_deletex')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\BrilhoController::deleteActionx',));
            }
            not_brilho_deletex:
        ...
        if (0 === strpos($pathinfo, '/c')) {
            if (0 === strpos($pathinfo, '/categoria')) {
                ...
                // categoria_new
                if (0 === strpos($pathinfo, '/categoria/new') && preg_match('#^/categoria/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_categoria_new;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'categoria_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\CategoriaController::newAction',));
                }
                not_categoria_new:

                // categoria_delete
                if (0 === strpos($pathinfo, '/categoria/delete') && preg_match('#^/categoria/delete(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_categoria_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'categoria_delete')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\CategoriaController::deleteAction',));
                }
                not_categoria_delete:

                // categoria_show
                if ($pathinfo === '/categoria/vvvv') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_categoria_show;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\MAC\\CategoriaController::showAction',  '_route' => 'categoria_show',);
                }
                not_categoria_show:

                // categoria_edit
                if (preg_match('#^/categoria/(?P<id>[^/]+)x/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                ...
                // categoria_deletex
                if (0 === strpos($pathinfo, '/categoria/x') && preg_match('#^/categoria/x(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'DELETE') {
                        $allow[] = 'DELETE';
                        goto not_categoria_deletex;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'categoria_deletex')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\CategoriaController::deleteActionx',));
                }
                not_categoria_deletex:
            ...
            if (0 === strpos($pathinfo, '/clivagem')) {
                ...
                // clivagem_new
                if (0 === strpos($pathinfo, '/clivagem/new') && preg_match('#^/clivagem/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_clivagem_new;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'clivagem_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\ClivagemController::newAction',));
                }
                not_clivagem_new:

                // clivagem_delete
                if (0 === strpos($pathinfo, '/clivagem/delete') && preg_match('#^/clivagem/delete(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_clivagem_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'clivagem_delete')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\ClivagemController::deleteAction',));
                }
                not_clivagem_delete:
        ...
        if (0 === strpos($pathinfo, '/Conservacao')) {
            // Conservacao_index
            if (rtrim($pathinfo, '/') === '/Conservacao') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_Conservacao_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'Conservacao_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\MAC\\ConservacaoController::indexAction',  '_route' => 'Conservacao_index',);
            }
            not_Conservacao_index:

            // Conservacao_new
            if ($pathinfo === '/Conservacao/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_Conservacao_new;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\MAC\\ConservacaoController::newAction',  '_route' => 'Conservacao_new',);
            }
            not_Conservacao_new:

            // Conservacao_show
            if (preg_match('#^/Conservacao/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_Conservacao_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Conservacao_show')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\ConservacaoController::showAction',));
            }
            not_Conservacao_show:

            // Conservacao_edit
            if (preg_match('#^/Conservacao/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_Conservacao_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Conservacao_edit')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\ConservacaoController::editAction',));
            }
            not_Conservacao_edit:

            // Conservacao_delete
            if (preg_match('#^/Conservacao/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_Conservacao_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'Conservacao_delete')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\ConservacaoController::deleteAction',));
            }
            not_Conservacao_delete:

        }

        if (0 === strpos($pathinfo, '/cor')) {
            // cor_new
            if (0 === strpos($pathinfo, '/cor/new') && preg_match('#^/cor/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_cor_new;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'cor_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\CorController::newAction',));
            }
            not_cor_new:
        ...
        if (0 === strpos($pathinfo, '/e')) {
            if (0 === strpos($pathinfo, '/elementosQuimicos')) {
                // elementoquimico_index
                if (rtrim($pathinfo, '/') === '/elementosQuimicos') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                if (0 === strpos($pathinfo, '/elementosQuimicos/new')) {
                    // elementoquimico_newx
                    if ($pathinfo === '/elementosQuimicos/newx') {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_elementoquimico_newx;
                        }

                        return array (  '_controller' => 'AppBundle\\Controller\\MAC\\ElementoquimicoController::newActionx',  '_route' => 'elementoquimico_newx',);
                    }
                    not_elementoquimico_newx:

                    // elementosQuimicos_new
                    if (preg_match('#^/elementosQuimicos/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_elementosQuimicos_new;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'elementosQuimicos_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\ElementoquimicoController::newAction',));
                    }
                    not_elementosQuimicos_new:

                }

                // elementosQuimicos_delete
                if (0 === strpos($pathinfo, '/elementosQuimicos/delete') && preg_match('#^/elementosQuimicos/delete(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_elementosQuimicos_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'elementosQuimicos_delete')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\ElementoquimicoController::deleteAction',));
                }
                not_elementosQuimicos_delete:

                // elementoquimico_show
                if (preg_match('#^/elementosQuimicos/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                ...
                if (preg_match('#^/elementosQuimicos/(?P<id>[^/]+)xx/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                ...
                // elementoquimico_deletex
                if (preg_match('#^/elementosQuimicos/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'DELETE') {
                        $allow[] = 'DELETE';
                        goto not_elementoquimico_deletex;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'elementoquimico_deletex')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\ElementoquimicoController::deleteActionx',));
                }
                not_elementoquimico_deletex:
        ...
        if (0 === strpos($pathinfo, '/f')) {
            ...
            if (0 === strpos($pathinfo, '/fra')) {
                if (0 === strpos($pathinfo, '/fractura')) {
                    // fratura_index
                    if (rtrim($pathinfo, '/') === '/fractura') {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    if (0 === strpos($pathinfo, '/fractura/new')) {
                        // fratura_newx
                        if ($pathinfo === '/fractura/newx') {
                            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                                goto not_fratura_newx;
                            }

                            return array (  '_controller' => 'AppBundle\\Controller\\MAC\\FraturaController::newActionx',  '_route' => 'fratura_newx',);
                        }
                        not_fratura_newx:

                        // fractura_new
                        if (preg_match('#^/fractura/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                                goto not_fractura_new;
                            }

                            return $this->mergeDefaults(array_replace($matches, array('_route' => 'fractura_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\FraturaController::newAction',));
                        }
                        not_fractura_new:
                    ...
                    // fractura_delete
                    if (0 === strpos($pathinfo, '/fractura/delete') && preg_match('#^/fractura/delete(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_fractura_delete;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fractura_delete')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\FraturaController::deleteAction',));
                    }
                    not_fractura_delete:

                    // fratura_showx
                    if (preg_match('#^/fractura/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'HEAD'));
                            goto not_fratura_showx;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fratura_showx')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\FraturaController::showAction',));
                    }
                    not_fratura_showx:

                    // fratura_editx
                    if (preg_match('#^/fractura/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_fratura_editx;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fratura_editx')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\FraturaController::editAction',));
                    }
                    not_fratura_editx:
                    ...
                    if (preg_match('#^/fractura/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                        if ($this->context->getMethod() != 'DELETE') {
                            $allow[] = 'DELETE';
                            goto not_fratura_deletex;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'fratura_deletex')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\FraturaController::deleteActionx',));
                    }
                    not_fratura_deletex:
        ...
        if (0 === strpos($pathinfo, '/genese')) {
            ...
            if (0 === strpos($pathinfo, '/genese/new')) {
                // genese_newx
                if ($pathinfo === '/genese/new') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_genese_newx;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\MAC\\GeneseController::newActionx',  '_route' => 'genese_newx',);
                }
                not_genese_newx:

                // genese_new
                if (preg_match('#^/genese/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_genese_new;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'genese_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\GeneseController::newAction',));
                }
                not_genese_new:
            ...
            // genese_delete
            if (0 === strpos($pathinfo, '/genese/delete') && preg_match('#^/genese/delete(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_genese_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'genese_delete')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\GeneseController::deleteAction',));
            }
            not_genese_delete:
            ...
            if (preg_match('#^/genese/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_genese_deletex;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'genese_deletex')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\GeneseController::deleteActionx',));
            }
            not_genese_deletex:
        ...
        if (0 === strpos($pathinfo, '/habito')) {
            ...
            // habito_new
            if (0 === strpos($pathinfo, '/habito/new') && preg_match('#^/habito/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_habito_new;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'habito_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\HabitoController::newAction',));
            }
            not_habito_new:

            // habito_delete
            if (0 === strpos($pathinfo, '/habito/delete') && preg_match('#^/habito/delete(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_habito_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'habito_delete')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\HabitoController::deleteAction',));
            }
            not_habito_delete:
            ...
            if ($pathinfo === '/habito/new') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_habito_newx;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\MAC\\HabitoController::newActionx',  '_route' => 'habito_newx',);
            }
            not_habito_newx:
            ...
            if (preg_match('#^/habito/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'DELETE') {
                    $allow[] = 'DELETE';
                    goto not_habito_deletex;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'habito_deletex')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\HabitoController::deleteActionx',));
            }
            not_habito_deletex:
        ...
        if (0 === strpos($pathinfo, '/p')) {
            ...
            if (0 === strpos($pathinfo, '/prateleira')) {
                ...
                if (0 === strpos($pathinfo, '/prateleira/new')) {
                    // prateleira_new
                    if (preg_match('#^/prateleira/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_prateleira_new;
                        }

                        return $this->mergeDefaults(array_replace($matches, array('_route' => 'prateleira_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\PrateleiraController::newAction',));
                    }
                    not_prateleira_new:
                    ...
                    if ($pathinfo === '/prateleira/new') {
                        if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                            $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                            goto not_prateleira_newx;
                        }

                        return array (  '_controller' => 'AppBundle\\Controller\\MAC\\PrateleiraController::newActionx',  '_route' => 'prateleira_newx',);
                    }
                    not_prateleira_newx:
                ...
                if (preg_match('#^/prateleira/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'DELETE') {
                        $allow[] = 'DELETE';
                        goto not_prateleira_deletex;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'prateleira_deletex')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\PrateleiraController::deleteActionx',));
                }
                not_prateleira_deletex:
        ...
        if (0 === strpos($pathinfo, '/r')) {
            ...
            if (0 === strpos($pathinfo, '/risca')) {
                // risca_index
                if (rtrim($pathinfo, '/') === '/risca') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_risca_index;
                    }

                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'risca_index');
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\MAC\\RiscaController::indexAction',  '_route' => 'risca_index',);
                }
                not_risca_index:

                // risca_new
                if (0 === strpos($pathinfo, '/risca/new') && preg_match('#^/risca/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_risca_new;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'risca_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\RiscaController::newAction',));
                }
                not_risca_new:

                // risca_delete
                if (0 === strpos($pathinfo, '/risca/delete') && preg_match('#^/risca/delete(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_risca_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'risca_delete')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\RiscaController::deleteAction',));
                }
                not_risca_delete:

                // risca_show
                if (preg_match('#^/risca/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_risca_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'risca_show')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\RiscaController::showAction',));
                }
                not_risca_show:

                // risca_edit
                if (preg_match('#^/risca/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_risca_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'risca_edit')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\RiscaController::editAction',));
                }
                not_risca_edit:
                ...
                if (preg_match('#^/risca/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'DELETE') {
                        $allow[] = 'DELETE';
                        goto not_risca_deletex;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'risca_deletex')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\RiscaController::deleteActionx',));
                }
                not_risca_deletex:
        ...
        if (0 === strpos($pathinfo, '/s')) {
            if (0 === strpos($pathinfo, '/seccao')) {
                // cor_index
                if (rtrim($pathinfo, '/') === '/seccao') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_cor_index;
                    }
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\MAC\\SeccaoController::indexAction',  '_route' => 'cor_index',);
                }
                not_cor_index:

                // seccao_new
                if (0 === strpos($pathinfo, '/seccao/new') && preg_match('#^/seccao/new(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_seccao_new;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'seccao_new')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\SeccaoController::newAction',));
                }
                not_seccao_new:

                // cor_delete
                if (0 === strpos($pathinfo, '/seccao/delete') && preg_match('#^/seccao/delete(?:/(?P<data>[^/]++))?$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_cor_delete;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cor_delete')), array (  'data' => NULL,  '_controller' => 'AppBundle\\Controller\\MAC\\SeccaoController::deleteAction',));
                }
                not_cor_delete:

                // cor_show
                if (preg_match('#^/seccao/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_cor_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cor_show')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\SeccaoController::showAction',));
                }
                not_cor_show:

                // cor_edit
                if (preg_match('#^/seccao/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_cor_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cor_edit')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\SeccaoController::editAction',));
                }
                not_cor_edit:
                ...
                if (preg_match('#^/seccao/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if ($this->context->getMethod() != 'DELETE') {
                        $allow[] = 'DELETE';
                        goto not_cor_deletex;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'cor_deletex')), array (  '_controller' => 'AppBundle\\Controller\\MAC\\SeccaoController::deleteActionx',));
                }
                not_cor_deletex:
        ...
        if (0 === strpos($pathinfo, '/membros')) {
            // membro_index
            if (rtrim($pathinfo, '/') === '/membros') {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_membro_index;
                }

                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'membro_index');
                }

                return array (  '_controller' => 'AppBundle\\Controller\\MUS\\MembrosController::indexAction',  '_route' => 'membro_index',);
            }
            not_membro_index:

            // membro_new
            if ($pathinfo === '/membros/novo') {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_membro_new;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\MUS\\MembrosController::newAction',  '_route' => 'membro_new',);
            }
            not_membro_new:

            // membro_edit
            if (0 === strpos($pathinfo, '/membros/editar') && preg_match('#^/membros/editar/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_membro_edit;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'membro_edit')), array (  '_controller' => 'AppBundle\\Controller\\MUS\\MembrosController::editAction',));
            }
            not_membro_edit:

            // pessoa_show
            if (preg_match('#^/membros/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_pessoa_show;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'pessoa_show')), array (  '_controller' => 'AppBundle\\Controller\\MUS\\MembrosController::showAction',));
            }
            not_pessoa_show:

            // membro_show_api
            if (0 === strpos($pathinfo, '/membros/api') && preg_match('#^/membros/api/(?P<tipo>[^/]++)/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_membro_show_api;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'membro_show_api')), array (  '_controller' => 'AppBundle\\Controller\\MUS\\MembrosController::membroApi',));
            }
            not_membro_show_api:

            // membro_delete
            if ($pathinfo === '/membros/delete') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_membro_delete;
                }

                return array (  '_controller' => 'AppBundle\\Controller\\MUS\\MembrosController::deleteAction',  '_route' => 'membro_delete',);
            }
            not_membro_delete:

            // reset_password
            if (0 === strpos($pathinfo, '/membros/resetpassword') && preg_match('#^/membros/resetpassword/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                    goto not_reset_password;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'reset_password')), array (  '_controller' => 'AppBundle\\Controller\\MUS\\MembrosController::resetpassword',));
            }
            not_reset_password:
        ...
        if (0 === strpos($pathinfo, '/v')) {
            if (0 === strpos($pathinfo, '/vv')) {
                // utilizadores
                if (rtrim($pathinfo, '/') === '/vv') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\MUS\\UtilizadorController::indexAction',  '_route' => 'utilizadores',);
                }
                not_utilizadores:
                ...
                if ($pathinfo === '/vv/new') {
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\MUS\\UtilizadorController::newAction',  '_route' => 'usuario_new',);
                }
                not_usuario_new:

                // usuario_show
                if (preg_match('#^/vv/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_usuario_show;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'usuario_show')), array (  '_controller' => 'AppBundle\\Controller\\MUS\\UtilizadorController::showAction',));
                }
                not_usuario_show:

                // usuario_edit
                if (preg_match('#^/vv/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_usuario_edit;
                    }

                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'usuario_edit')), array (  '_controller' => 'AppBundle\\Controller\\MUS\\UtilizadorController::editAction',));
                }
                not_usuario_edit:
                ...
                if (preg_match('#^/vv/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'usuario_delete')), array (  '_controller' => 'AppBundle\\Controller\\MUS\\UtilizadorController::deleteAction',));
                }
                not_usuario_delete:
                ...
                if ($pathinfo === '/vv/save') {
                    ...
                    return array (  '_controller' => 'AppBundle\\Controller\\MUS\\UtilizadorController::createAction',  '_route' => 'usuario_save',);
                }
                not_usuario_save:
            ...
            if (0 === strpos($pathinfo, '/visita')) {
                ...
                if (rtrim($pathinfo, '/') === '/visita') {
                    if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'HEAD'));
                        goto not_visita_view;
                    }

                    if (substr($pathinfo, -1) !== '/') {
                        return $this->redirect($pathinfo.'/', 'visita_view');
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\MVS\\VisitaController::indexAction',  '_route' => 'visita_view',);
                }
                not_visita_view:

                // visita_new
                if ($pathinfo === '/visita/novo') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_visita_new;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\MVS\\VisitaController::novaVisita',  '_route' => 'visita_new',);
                }
                not_visita_new:

                // visita_able
                if ($pathinfo === '/visita/ativar') {
                    if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                        $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                        goto not_visita_able;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\MVS\\VisitaController::activar',  '_route' => 'visita_able',);
                }
                not_visita_able:
                ...
                if (preg_match('#^/visita/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                    ...
                    return $this->mergeDefaults(array_replace($matches, array('_route' => 'visita_edit')), array (  '_controller' => 'AppBundle\\Controller\\MVS\\VisitaController::editarVisita',));
                }
                not_visita_edit:

                // visita_delete
                if ($pathinfo === '/visita/delete') {
                    if ($this->context->getMethod() != 'POST') {
                        $allow[] = 'POST';
                        goto not_visita_delete;
                    }

                    return array (  '_controller' => 'AppBundle\\Controller\\MVS\\VisitaController::deleteAction',  '_route' => 'visita_delete',);
                }
                not_visita_delete:
        ...
        if (rtrim($pathinfo, '/') === '/upload') {
            if (!in_array($this->context->getMethod(), array('GET', 'POST', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'POST', 'HEAD'));
                goto not_UPLOAD_index;
            }

            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'UPLOAD_index');
            }

            return array (  '_controller' => 'AppBundle\\Controller\\SYS\\FileUpload::indexAction',  '_route' => 'UPLOAD_index',);
        }
        not_UPLOAD_index:
