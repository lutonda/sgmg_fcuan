...
class Taxonomia
{
     ...
     * @return Taxonomia
     */
    public function setFilo(Filo $idfilo = null)
    {
        $this->idfilo = $idfilo;
     ...
     * @return Taxonomia
     */
    public function setReino(Reino $idreino = null)
    {
     ...
     * @return Taxonomia
     */
    public function setClasse(Classe $idclasse = null)
    {
     ...
     * @return Taxonomia
     */
    public function setSubclasse(Subclasse $idsubclasse = null)
    {
     ...
     * @return Taxonomia
     */
    public function setOrdem(Ordem $idordem = null)
    {
     ...
     * @return Taxonomia
     */
    public function setSubordem(Subordem $idsubordem = null)
    {
     ...
     * @return Taxonomia
     */
    public function setFamilia(Familia $idfamilia = null)
    {
