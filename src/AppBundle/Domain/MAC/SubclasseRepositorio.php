...
use AppBundle\Entity\MAC\Subclasse;
...
class SubclasseRepositorio extends EntityRepository implements UserLoaderInterface
{
    protected $em;
    ...
    public function mostrarTodos()
    {
        $cores = $this
            ->em
            ->getRepository('AppBundle:MAC\Subclasse')
            ->findBy([],['nome'=>'ASC']);
        return $cores;
    }
    ...
    {
        return $this->em->getRepository('AppBundle:MAC\Subclasse')->findOneBy(array('id' => $brilho));
    ...
    public function actualizarUm($brilho)
    {
        ...
        $cat = $this->em->getRepository('AppBundle:MAC\Subclasse')->findOneBy(array('id' => $brilho->getId()));
