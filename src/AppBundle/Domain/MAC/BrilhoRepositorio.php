...
class BrilhoRepositorio extends EntityRepository implements UserLoaderInterface
{
    protected $em;
    ...
    public function mostrarTodos()
    {
        $cores = $this
            ->em
            ->getRepository('AppBundle:MAC\Brilho')
            ->findBy([],['nome'=>'ASC']);
        return $cores;
    }
    ...
    {
        return $this->em->getRepository('AppBundle:MAC\Brilho')->findOneBy(array('id' => $brilho));
    }

    public function mostrarMineiros($mineiro)
    {
        $qb = $this->em->getRepository('AppBundle:MAC\Brilhomineiro')->findBy(array('idmineiro' => $mineiro));
        $brilhos = null;
    ...
    public function actualizarUm($brilho)
    {
        ...
        $cat = $this->em->getRepository('AppBundle:MAC\Brilho')->findOneBy(array('id' => $brilho->getId()));
