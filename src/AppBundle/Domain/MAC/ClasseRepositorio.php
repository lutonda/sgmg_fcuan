...
use AppBundle\Entity\MAC\Classe;
...
class ClasseRepositorio extends EntityRepository implements UserLoaderInterface
{
    protected $em;
    ...
    public function mostrarTodos()
    {
        $cores = $this
            ->em
            ->getRepository('AppBundle:MAC\Classe')
            ->findBy([],['nome'=>'ASC']);
        return $cores;
    }

    public function mostrarUm($classe)
    {
        return $this->em->getRepository('AppBundle:MAC\Classe')->findOneBy(array('id' => $classe));


    }

    public function criarUm($classe)
    {
    ...
    public function actualizarUm($classe)
    {

        $cat = $this->em->getRepository('AppBundle:MAC\Classe')->findOneBy(array('id' => $classe->getId()));
        $cat->setNome($classe->getNome());
        $cat->setDescricao($classe->getDescricao());
        $this->em->flush();
        return true;
    }

    public function eliminarUm($classe)
    {
